#!/usr/bin/env python3
"""Review knowledge_discipline.csv quality (T266). Network: none."""
from __future__ import annotations
import csv, subprocess, sys
from collections import Counter, defaultdict
from pathlib import Path
ROOT = Path(__file__).resolve().parent.parent
TARGET = ROOT / "data" / "knowledge_discipline.csv"
REPORT = ROOT / "docs" / "reviews" / "T266-discipline-review.md"
EXPECTED_ROWS = 300
SAMPLE_SIZE = 50
ID_PREFIX = "WC-DISC"
CATEGORY_L1 = "裁判与纪律"
...
def main() -> int:
    ...
    lines = ["# T266 质量抽检报告", "", f"- 总行数: **{len(rows)}**", f"- 校验: **{'PASS' if validate.returncode==0 else 'FAIL'}**", ""]
