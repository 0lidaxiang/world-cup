#!/usr/bin/env python3
"""Review knowledge_records_stats.csv quality (T255). Network: none."""
from __future__ import annotations
import csv, subprocess, sys
from collections import Counter, defaultdict
from pathlib import Path
ROOT = Path(__file__).resolve().parent.parent
TARGET = ROOT / "data" / "knowledge_records_stats.csv"
REPORT = ROOT / "docs" / "reviews" / "T255-records-stats-review.md"
EXPECTED_ROWS = 800
SAMPLE_SIZE = 50
ID_PREFIX = "WC-RECD"
CATEGORY_L1 = "纪录与统计"
...
def main() -> int:
    ...
    lines = ["# T255 质量抽检报告", "", f"- 总行数: **{len(rows)}**", f"- 校验: **{'PASS' if validate.returncode==0 else 'FAIL'}**", ""]
