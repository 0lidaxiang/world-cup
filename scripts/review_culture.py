#!/usr/bin/env python3
"""Review knowledge_culture.csv quality (T296). Network: none."""
from __future__ import annotations
import csv, subprocess, sys
from collections import Counter, defaultdict
from pathlib import Path
ROOT = Path(__file__).resolve().parent.parent
TARGET = ROOT / "data" / "knowledge_culture.csv"
REPORT = ROOT / "docs" / "reviews" / "T296-culture-review.md"
EXPECTED_ROWS = 300
SAMPLE_SIZE = 50
ID_PREFIX = "WC-CULT"
CATEGORY_L1 = "足球文化与观赛"
...
def main() -> int:
    ...
    lines = ["# T296 质量抽检报告", "", f"- 总行数: **{len(rows)}**", f"- 校验: **{'PASS' if validate.returncode==0 else 'FAIL'}**", ""]
