#!/usr/bin/env python3
"""Review knowledge_tactics.csv quality (T231). Network: none."""
from __future__ import annotations
import csv, subprocess, sys
from collections import Counter, defaultdict
from pathlib import Path
ROOT = Path(__file__).resolve().parent.parent
TARGET = ROOT / "data" / "knowledge_tactics.csv"
REPORT = ROOT / "docs" / "reviews" / "T231-tactics-review.md"
EXPECTED_ROWS = 600
SAMPLE_SIZE = 50
ID_PREFIX = "WC-TACT"
CATEGORY_L1 = "战术与位置"
...
def main() -> int:
    ...
    lines = ["# T231 质量抽检报告", "", f"- 总行数: **{len(rows)}**", f"- 校验: **{'PASS' if validate.returncode==0 else 'FAIL'}**", ""]
