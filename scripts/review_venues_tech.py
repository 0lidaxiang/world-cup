#!/usr/bin/env python3
"""Review knowledge_venues_tech.csv quality (T278). Network: none."""
from __future__ import annotations
import csv, subprocess, sys
from collections import Counter, defaultdict
from pathlib import Path
ROOT = Path(__file__).resolve().parent.parent
TARGET = ROOT / "data" / "knowledge_venues_tech.csv"
REPORT = ROOT / "docs" / "reviews" / "T278-venues-tech-review.md"
EXPECTED_ROWS = 400
SAMPLE_SIZE = 50
ID_PREFIX = "WC-VTEC"
CATEGORY_L1 = "场地装备与科技"
...
def main() -> int:
    ...
    lines = ["# T278 质量抽检报告", "", f"- 总行数: **{len(rows)}**", f"- 校验: **{'PASS' if validate.returncode==0 else 'FAIL'}**", ""]
