...
> 用户向版本说明见根目录 [`CHANGELOG.md`](../../CHANGELOG.md)。
...
- **T503**：`scripts/review_t503.py`（seed=42）对 `knowledge_all.csv` 抽检 500 条，全库 **10,910** 条，禁赌词零命中，报告见 `docs/maintainers/reviews/T503-full-sample-review.md`
- **T404**：Skill 端到端复验通过，全库 **10,910** 条、`entities.csv` **449** 条，报告见 `docs/maintainers/reviews/T404-skill-e2e-test.md`
...
- 报告见 `docs/maintainers/reviews/quality-debt-report.md`
